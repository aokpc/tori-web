 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(I,j){var K=I.length;I.push(j);e:for(;0<K;){var se=K-1>>>1,Se=I[se];if(0<r(Se,j))I[se]=j,I[K]=Se,K=se;else break e}}function t(I){return I.length===0?null:I[0]}function i(I){if(I.length===0)return null;var j=I[0],K=I.pop();if(K!==j){I[0]=K;e:for(var se=0,Se=I.length,Ze=Se>>>1;se<Ze;){var X=2*(se+1)-1,re=I[X],pe=X+1,oe=I[pe];if(0>r(re,K))pe<Se&&0>r(oe,re)?(I[se]=oe,I[pe]=K,se=pe):(I[se]=re,I[X]=K,se=X);else if(pe<Se&&0>r(oe,K))I[se]=oe,I[pe]=K,se=pe;else break e}}return j}function r(I,j){var K=I.sortIndex-j.sortIndex;return K!==0?K:I.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],u=1,f=null,h=3,p=!1,g=!1,_=!1,m=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(I){for(var j=t(c);j!==null;){if(j.callback===null)i(c);else if(j.startTime<=I)i(c),j.sortIndex=j.expirationTime,e(l,j);else break;j=t(c)}}function y(I){if(_=!1,x(I),!g)if(t(l)!==null)g=!0,G(R);else{var j=t(c);j!==null&&Q(y,j.startTime-I)}}function R(I,j){g=!1,_&&(_=!1,d(C),C=-1),p=!0;var K=h;try{for(x(j),f=t(l);f!==null&&(!(f.expirationTime>j)||I&&!L());){var se=f.callback;if(typeof se=="function"){f.callback=null,h=f.priorityLevel;var Se=se(f.expirationTime<=j);j=n.unstable_now(),typeof Se=="function"?f.callback=Se:f===t(l)&&i(l),x(j)}else i(l);f=t(l)}if(f!==null)var Ze=!0;else{var X=t(c);X!==null&&Q(y,X.startTime-j),Ze=!1}return Ze}finally{f=null,h=K,p=!1}}var b=!1,w=null,C=-1,T=5,M=-1;function L(){return!(n.unstable_now()-M<T)}function W(){if(w!==null){var I=n.unstable_now();M=I;var j=!0;try{j=w(!0,I)}finally{j?k():(b=!1,w=null)}}else b=!1}var k;if(typeof v=="function")k=function(){v(W)};else if(typeof MessageChannel<"u"){var H=new MessageChannel,q=H.port2;H.port1.onmessage=W,k=function(){q.postMessage(null)}}else k=function(){m(W,0)};function G(I){w=I,b||(b=!0,k())}function Q(I,j){C=m(function(){I(n.unstable_now())},j)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(I){I.callback=null},n.unstable_continueExecution=function(){g||p||(g=!0,G(R))},n.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<I?Math.floor(1e3/I):5},n.unstable_getCurrentPriorityLevel=function(){return h},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(I){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var K=h;h=j;try{return I()}finally{h=K}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(I,j){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var K=h;h=I;try{return j()}finally{h=K}},n.unstable_scheduleCallback=function(I,j,K){var se=n.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?se+K:se):K=se,I){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=K+Se,I={id:u++,callback:j,priorityLevel:I,startTime:K,expirationTime:Se,sortIndex:-1},K>se?(I.sortIndex=K,e(c,I),t(l)===null&&I===t(c)&&(_?(d(C),C=-1):_=!0,Q(y,K-se))):(I.sortIndex=Se,e(l,I),g||p||(g=!0,G(R))),I},n.unstable_shouldYield=L,n.unstable_wrapCallback=function(I){var j=h;return function(){var K=h;h=j;try{return I.apply(this,arguments)}finally{h=K}}}})(O_);F_.exports=O_;var Ay=F_.exports;/**
 * @license React
...
`)+`
`+d);const x=v+m+o,y=v+d+a,R=u_(r,r.VERTEX_SHADER,x),b=u_(r,r.FRAGMENT_SHADER,y);r.attachShader(_,R),r.attachShader(_,b),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function w(L){if(n.debug.checkShaderErrors){const W=r.getProgramInfoLog(_).trim(),k=r.getShaderInfoLog(R).trim(),H=r.getShaderInfoLog(b).trim();let q=!0,G=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,R,b);else{const Q=h_(r,R,"vertex"),I=h_(r,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
