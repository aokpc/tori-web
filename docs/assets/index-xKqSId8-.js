...
`)+`
`+d);const x=v+m+o,y=v+d+a,R=u_(r,r.VERTEX_SHADER,x),b=u_(r,r.FRAGMENT_SHADER,y);r.attachShader(_,R),r.attachShader(_,b),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function w(L){if(n.debug.checkShaderErrors){const W=r.getProgramInfoLog(_).trim(),F=r.getShaderInfoLog(R).trim(),H=r.getShaderInfoLog(b).trim();let q=!0,G=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,R,b);else{const Q=h_(r,R,"vertex"),I=h_(r,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
